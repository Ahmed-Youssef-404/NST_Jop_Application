...
/** Section 5B — Growth & Outreach Team */
export const growthQuestions: Question[] = [
  ...
  },
  {
    ...
    number: 17,
    title:
      "If you joined the Growth & Outreach Team tomorrow, what is one thing you would try to improve about NST's visibility or growth, and why?",
    type: "paragraph",
    required: true,
  },
  {
